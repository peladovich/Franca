...
<div class="max-w-md mx-auto py-lg">
  ...
  <form method="post" class="bg-surface-container-lowest rounded-xl p-lg space-y-4 editorial-shadow">
    ...
    <button class="btn-lift w-full bg-accent text-on-accent py-4 rounded-full font-label-md uppercase tracking-widest" type="submit"><?= e(t('auth.create_account_btn')) ?></button>
