...
<h1 class="font-headline-md text-headline-md text-primary mb-lg"><?= e(t('admin.dashboard_title')) ?></h1>
...
<div class="grid grid-cols-2 lg:grid-cols-5 gap-md mb-xl">
  <div class="bg-surface-container-lowest rounded-xl p-md editorial-shadow">
    <p class="font-caption text-on-surface-variant uppercase tracking-wide mb-1"><?= e(t('admin.stat_menu_items')) ?></p>
    <p class="font-headline-md text-headline-md text-primary"><?= (int)$stats['menu_items'] ?></p>
  </div>
  <div class="bg-surface-container-lowest rounded-xl p-md editorial-shadow">
    <p class="font-caption text-on-surface-variant uppercase tracking-wide mb-1"><?= e(t('admin.stat_orders_today')) ?></p>
    <p class="font-headline-md text-headline-md text-primary"><?= (int)$stats['orders_today'] ?></p>
  </div>
  <div class="bg-surface-container-lowest rounded-xl p-md editorial-shadow">
    <p class="font-caption text-on-surface-variant uppercase tracking-wide mb-1"><?= e(t('admin.stat_revenue_today')) ?></p>
    <p class="font-headline-md text-headline-md text-primary"><?= money((float)$stats['revenue_today']) ?></p>
  </div>
  <div class="bg-surface-container-lowest rounded-xl p-md editorial-shadow">
    <p class="font-caption text-on-surface-variant uppercase tracking-wide mb-1"><?= e(t('admin.stat_upcoming_reservations')) ?></p>
    <p class="font-headline-md text-headline-md text-primary"><?= (int)$stats['reservations_upcoming'] ?></p>
  </div>
  <div class="bg-surface-container-lowest rounded-xl p-md editorial-shadow">
    <p class="font-caption text-on-surface-variant uppercase tracking-wide mb-1"><?= e(t('admin.stat_customers')) ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-lg">
  <section>
    <div class="flex justify-between items-center mb-md">
      <h2 class="font-headline-sm text-headline-sm text-primary"><?= e(t('admin.recent_orders')) ?></h2>
      <a href="<?= BASE_URL ?>/admin/orders.php" class="font-label-md text-secondary text-sm"><?= e(t('admin.view_all')) ?></a>
    </div>
    <?php if (!$recentOrders): ?>
      <p class="font-body-md text-on-surface-variant"><?= e(t('admin.no_orders_yet')) ?></p>
    <?php else: ?>
      <div class="space-y-2">
        <?php foreach ($recentOrders as $o): ?>
        <div class="bg-surface-container-lowest rounded-lg p-3 flex justify-between items-center">
          <span class="font-body-md">#<?= (int)$o['id'] ?> · <?= e($o['guest_name'] ?: t('admin.registered_user')) ?></span>
  ...
  <section>
    <div class="flex justify-between items-center mb-md">
      <h2 class="font-headline-sm text-headline-sm text-primary"><?= e(t('admin.stat_upcoming_reservations')) ?></h2>
      <a href="<?= BASE_URL ?>/admin/reservations.php" class="font-label-md text-secondary text-sm"><?= e(t('admin.view_all')) ?></a>
    </div>
    <?php if (!$upcomingRes): ?>
      <p class="font-body-md text-on-surface-variant"><?= e(t('admin.no_upcoming_reservations')) ?></p>
    <?php else: ?>
      <div class="space-y-2">
